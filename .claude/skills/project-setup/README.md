...
(spec, architecture, changelog, status, per-feature references), plugin and MCP server
walkthroughs, slash commands, subagents, and hooks.
...
assets/
  templates/                   project_spec, CLAUDE.md, ARCHITECTURE, CHANGELOG,
                               PROJECT_STATUS, reference-doc, env.example
  commands/                    commit, commit-push-pr, update-docs-and-commit, create-issues
